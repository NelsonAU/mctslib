...
PYBIND11_MODULE(_mctslib_hrave, m)
{
    ...
    using PyTreeIterHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_iter_move_no_rng), IterMCTSSettings, false>>;
    ...
    using PyTreeCPUHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_cpu_move_no_rng), CPUMCTSSettings, false>>;
    ...
    using PyTreeIterRNGHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_iter_move_rng), IterMCTSSettings, false>>;
    ...
    using PyTreeCPURNGHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_cpu_move_rng), CPUMCTSSettings, false>>;
    ...
    using PyDAGIterHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_iter_move_no_rng), IterMCTSSettings, true>>;
    py::class_<PyDAGIterHRAVE>(m, "dag_iters_HRAVE")
        .def(py::init<py::object, uint, uint>())
        .def("move", &PyDAGIterHRAVE::move<uint, uint, double>, "", py::kw_only(),
            py::arg("rollout_depth"), py::arg("iters"), py::arg("exploration_weight") = sqrt(2));

    using PyDAGCPUHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_cpu_move_no_rng), CPUMCTSSettings, true>>;
    py::class_<PyDAGCPUHRAVE>(m, "dag_cpu_time_HRAVE")
        .def(py::init<py::object, uint, uint>())
        .def("move", &PyDAGCPUHRAVE::move<uint, double, double>, "", py::kw_only(),
            py::arg("rollout_depth"), py::arg("cpu_time"), py::arg("exploration_weight") = sqrt(2));

    using PyDAGIterRNGHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_iter_move_rng), IterMCTSSettings, true>>;
    py::class_<PyDAGIterRNGHRAVE>(m, "dag_iters_randomized_ties_HRAVE")
        .def(py::init<py::object, uint, uint>())
        .def("move", &PyDAGIterRNGHRAVE::move<uint, uint, double>, "", py::kw_only(),
            py::arg("rollout_depth"), py::arg("iters"), py::arg("exploration_weight") = sqrt(2));

    using PyDAGCPURNGHRAVE = PyAlg<HRAVE<PythonNode<HRAVEStats>, decltype(hrave_cpu_move_rng), CPUMCTSSettings, true>>;
