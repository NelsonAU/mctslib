...
PYBIND11_MODULE(_mctslib_rave, m)
{
    ...
    register_RAVE<RAVE<PythonNode<RAVEStats>, false, false, false>>(m);
    register_RAVE<RAVE<PythonNode<RAVEStats>, false, false, true>>(m);
    register_RAVE<RAVE<PythonNode<RAVEStats>, false, true, false>>(m);
    register_RAVE<RAVE<PythonNode<RAVEStats>, false, true, true>>(m);

    register_RAVE<RAVE<PythonNode<RAVEStats>, true, false, false>>(m);
    register_RAVE<RAVE<PythonNode<RAVEStats>, true, false, true>>(m);
    register_RAVE<RAVE<PythonNode<RAVEStats>, true, true, false>>(m);
    register_RAVE<RAVE<PythonNode<RAVEStats>, true, true, true>>(m);
}
